!(function (t, e) {
    ...
    var u = {};
    u.VERSION = "5.5.2";
    var s = { en: { OK: "OK", CANCEL: "Cancel", CONFIRM: "OK" } },
        d = {
            dialog:
    ...
    function m(t, e, o, a) {
        a &&
            a[0] &&
            ((i = a[0].locale || b.locale),
            (a[0].swapButtonOrder || b.swapButtonOrder) && (e = e.reverse()));
        var r,
            n,
            i = {
                className: "bootbox-" + t,
    ...
    function x(t, e, o) {
        t.stopPropagation(),
            t.preventDefault(),
            (c.isFunction(o) && !1 === o.call(e, t)) || e.modal("hide");
    }
    function k(t) {
    ...
    return (
        (u.locales = function (t) {
            return t ? s[t] : s;
        }),
        (u.addLocale = function (t, o) {
            return (
                c.each(["OK", "CANCEL", "CONFIRM"], function (t, e) {
                    if (!o[e])
                        throw new Error(
                            'Please supply a translation for "' + e + '"'
                        );
                }),
                (s[t] = { OK: o.OK, CANCEL: o.CANCEL, CONFIRM: o.CONFIRM }),
                u
            );
        }),
        (u.removeLocale = function (t) {
            if ("en" === t)
                throw new Error(
        ...
        (u.setLocale = function (t) {
            return u.setDefaults("locale", t);
        }),
        ...
        (u.dialog = function (t) {
            ...
            (t = (function (a) {
                ...
                (a = c.extend({}, b, a)).backdrop
                    ? (a.backdrop =
                          "string" != typeof a.backdrop ||
                          "static" !== a.backdrop.toLowerCase() ||
                          "static")
                    : (a.backdrop =
                          !1 !== a.backdrop && 0 !== a.backdrop && "static");
                a.buttons || (a.buttons = {});
                return (
                    (r = a.buttons),
                    (n = h(r)),
                    w(r, function (t, e, o) {
                        if (
                            (c.isFunction(e) && (e = r[t] = { callback: e }),
                            "object" !== c.type(e))
                        )
                            throw new Error(
                ...
                c.fn.modal.Constructor.VERSION
                    ? ((t.fullBootstrapVersion =
                          c.fn.modal.Constructor.VERSION),
                      (i = t.fullBootstrapVersion.indexOf(".")),
            ...
            var o = c(d.dialog),
                e = o.find(".modal-dialog"),
                a = o.find(".modal-body"),
                r = c(d.header),
                n = c(d.footer),
                i = t.buttons,
                l = { onEscape: t.onEscape };
            if (
                (a.find(".bootbox-body").html(t.message),
                0 < h(t.buttons) &&
                    (w(i, function (t, e) {
                        var o = c(d.button);
                        switch (
                        ...
                        o.html(e.label), n.append(o), (l[t] = e.callback);
                    }),
                    a.after(n)),
            ...
            if (
                (t.scrollable &&
                    (e.addClass("modal-dialog-scrollable"),
                ...
                t.title && (a.before(r), o.find(".modal-title").html(t.title)),
                t.closeButton &&
                    ((r = c(d.closeButton)),
                    t.title
                        ? 3 < t.bootstrap
                            ? o.find(".modal-header").append(r)
                            : o.find(".modal-header").prepend(r)
                        : r.prependTo(a)),
                t.centerVertical &&
                    (e.addClass("modal-dialog-centered"),
                ...
                t.reusable || o.one("hide.bs.modal", { dialog: o }, y),
                t.onHide)
            ) {
                if (!c.isFunction(t.onHide))
                    throw new Error(
            ...
            if (
                (t.reusable || o.one("hidden.bs.modal", { dialog: o }, v),
                t.onHidden)
            ) {
                if (!c.isFunction(t.onHidden))
                    throw new Error(
            ...
            return (
                    ...
                    o.on("click.dismiss.bs.modal", function (t) {
                        o.children(".modal-backdrop").length &&
                            ...
                            t.target === t.currentTarget &&
                                o.trigger("escape.close.bb");
                    }),
                o.on("escape.close.bb", function (t) {
                    l.onEscape && x(t, o, l.onEscape);
                }),
                o.on(
                    "click",
                ...
                c(t.container).append(o),
                o.modal({ backdrop: t.backdrop, keyboard: !1, show: !1 }),
                t.show && o.modal("show"),
                o
            );
        }),
        (u.alert = function () {
            var t = m("alert", ["ok"], ["message", "callback"], arguments);
            if (t.callback && !c.isFunction(t.callback))
                throw new Error(
        ...
        (u.prompt = function () {
            ...
            if (
                (n.value || (n.value = b.value),
                n.inputType || (n.inputType = b.inputType),
                (t = (n.show === p ? b : n).show),
                (n.show = !1),
                ...
                (n.buttons.confirm.callback = function () {
                    ...
                    return n.callback.call(this, t);
                }),
                !n.title)
            )
                throw new Error("prompt requires a title");
            if (!c.isFunction(n.callback))
                throw new Error("prompt requires a callback");
            if (!d.inputs[n.inputType]) throw new Error("Invalid prompt type");
            switch (((r = c(d.inputs[n.inputType])), n.inputType)) {
                case "text":
                case "textarea":
                case "email":
                case "password":
                    r.val(n.value),
                        n.placeholder && r.attr("placeholder", n.placeholder),
                        n.pattern && r.attr("pattern", n.pattern),
                        n.maxlength && r.attr("maxlength", n.maxlength),
                        n.required && r.prop({ required: !0 }),
                        n.rows &&
                ...
                case "range":
                    if (
                        ...
                        if (
                            !(
                                "any" === n.step ||
                                (!isNaN(n.step) && 0 < parseFloat(n.step))
                            )
                        )
                            throw new Error(
                    ...
                    !(function (t, e, o) {
                        ...
                        (n.min !== p && r.attr("min", n.min),
                        n.max !== p && r.attr("max", n.max));
                    break;
                case "select":
                    var i = {},
                        a = n.inputOptions || [];
                    ...
                    n.placeholder && r.attr("placeholder", n.placeholder),
                        n.required && r.prop({ required: !0 }),
                        n.multiple && r.prop({ multiple: !0 }),
                        w(a, function (t, e) {
                            var o = r;
                            if (e.value === p || e.text === p)
                                throw new Error(
                                    'each option needs a "value" property and a "text" property'
                                );
                            e.group &&
                                (i[e.group] ||
                                    (i[e.group] = c("<optgroup />").attr(
                                        "label",
                                        e.group
                                    )),
                                (o = i[e.group]));
                    ...
                    break;
                case "checkbox":
                    var l = c.isArray(n.value) ? n.value : [n.value];
                    if (!(a = n.inputOptions || []).length)
                        throw new Error(
                            'prompt with "inputType" set to "checkbox" requires at least one option'
                        );
                    (r = c('<div class="bootbox-checkbox-list"></div>')),
                        w(a, function (t, o) {
                            if (o.value === p || o.text === p)
                                throw new Error(
                                    'each option needs a "value" property and a "text" property'
                                );
                            var a = c(d.inputs[n.inputType]);
                    ...
                    break;
                case "radio":
                    if (n.value !== p && c.isArray(n.value))
                        throw new Error(
                    ...
                    r = c('<div class="bootbox-radiobutton-list"></div>');
                    var s = !0;
                    w(a, function (t, e) {
                        if (e.value === p || e.text === p)
                            throw new Error(
            ...
            return (
                ...
                "" !== c.trim(n.message) &&
                    ((a = c(d.promptMessage).html(n.message)), o.prepend(a)),
                (n.message = o),
                (e = u.dialog(n)).off("shown.bs.modal", g),
