                           ...
                           <div class="card-block">
                              ...
                              @include('common.flash-message')
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                       <div class="form-material">
                                          <textarea class="form-control" id="installation_address" name="installation_address" rows="1" placeholder="Installation Address" style="resize: none;"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                       <div class="form-material">
                                          <input class="form-control" type="text" id="warranty_period" name="warranty_period" placeholder="Please enter warranty period">
